...
if goal == 'Lose Weight':
    ...
    col2.metric("Daily Calories", np.round(daily_cals,1))
    col3.metric("Daily Macros - Proteins", np.round(daily_proteins,1))
    col4.metric("Daily Macros - Carbs", np.round(daily_carbs,1))
    col5.metric("Daily Macros - Fats", np.round(daily_fats,1))
